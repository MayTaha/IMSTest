...
export class ProductServiceProxy {
     ...
     * @return Success
     */
    createOrEdit(body: ProductDto | undefined): Observable<ProductDto> {
    ...
    protected processCreateOrEdit(response: HttpResponseBase): Observable<ProductDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @param quantityOperator (optional) 
     * @param creationTime (optional) 
     * @param skipCount (optional) 
     * @param maxResultCount (optional) 
     * @return Success
     */
    getAll(title: string | null | undefined, code: string | null | undefined, quantity: number | null | undefined, quantityOperator: QuantityOperator | undefined, creationTime: moment.Moment | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ProductDtoPagedResultDto> {
        ...
        if (quantityOperator === null)
            throw new Error("The parameter 'quantityOperator' cannot be null.");
        else if (quantityOperator !== undefined)
            url_ += "QuantityOperator=" + encodeURIComponent("" + quantityOperator) + "&";
